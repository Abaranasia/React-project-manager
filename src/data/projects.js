export const projects = [
  {
    id: 123,
    name: "Maint App",
    desc: "Main I-Care report and route planning application",
    type: "MERN application",
    owner: "Gorick Davidts",
    ...
    resources: [
      {
        name: "Higinio Martí",
        tasks: ["back-end development", "scrum master", "dev-ops", "data architecture"],
        availability: "full",
      },
      {
        name: "Aitor Magnieto",
        tasks: ["front-end development", "back-end support", "client support"],
        availability: "full",
      },
      {
      ...
      {
        name: "Jose Luis Sánchez",
        tasks: ["front-end development"],
        availability: "full",
      },
      {
        name: "Diego Nicolás Ríos",
        tasks: ["front-end development"],
        availability: "full",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "Jesús Ponce",
        tasks: ["back-end development", "front-end development"],
        availability: "full",
      },
      {
        name: "Juan Valls",
      ...
      {
        name: "David Salazar",
        tasks: ["front-end development", "back-end support"],
        availability: "full",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "Higinio Martí",
        tasks: ["back-end development", "data architecture"],
        availability: "full",
      },
      {
        name: "Francisco Rodríguez",
      ...
      {
        name: "Aitor Magnieto",
        tasks: ["UX-UD Design", "fron-end support"],
        availability: "half",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "Michael Guadagnino",
        tasks: ["back-end development", "front-end development", "Dev-ops", "data architecture"],
        availability: "full",
      },
      {
        name: "Guillaume Kern",
        tasks: ["front-end development", "back-end development"],
        availability: "full",
      },
    ],
  },
  {
    ...
    resources: [
      {
        name: "Jose Luis Sánchez",
        tasks: ["back-end development", "database maintenance"],
        availability: "half",
      },
      {
        name: "Ernest Valentín Faulhaber",
        tasks: ["front-end development"],
        availability: "full",
      },
    ],
